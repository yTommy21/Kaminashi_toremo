...
public class AppSound : MonoBehaviour {
	...
	void Awake () {
		...
		SE_ATK_A1  				= fm.LoadResourcesSound("SE","SE_ATK");
		SE_ATK_A2  				= fm.LoadResourcesSound("SE","SE_Effect");
		SE_ATK_A3  				= fm.LoadResourcesSound("SE","SE_FootStep");
		...
		SE_ATK_ARIAL  			= fm.LoadResourcesSound("SE","SE_HIT");
		SE_ATK_SYURIKEN  		= fm.LoadResourcesSound("SE","SE_ATK_Syuriken");

		SE_HIT_A1	  			= fm.LoadResourcesSound("SE","SE_HIT");
		SE_HIT_A2	  			= fm.LoadResourcesSound("SE","SE_HIT");
		SE_HIT_A3	  			= fm.LoadResourcesSound("SE","SE_HIT");
#if xxx
		...
		SE_MOV_JUMP  			= fm.LoadResourcesSound("SE","SE_Hold");
